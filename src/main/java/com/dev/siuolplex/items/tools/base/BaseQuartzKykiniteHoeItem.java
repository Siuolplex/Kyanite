...
public class BaseQuartzKykiniteHoeItem extends BaseKykiniteHoeItem {
    @Override
    ...
    public BaseQuartzKykiniteHoeItem(BaseQuartzKykiniteToolMaterial material, int attackDamage, float attackSpeed, FabricItemSettings settings) {
