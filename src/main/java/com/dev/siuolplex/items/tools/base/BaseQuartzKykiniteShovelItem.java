...
public class BaseQuartzKykiniteShovelItem extends BaseKykiniteShovelItem {
    @Override
    ...
    public BaseQuartzKykiniteShovelItem(BaseQuartzKykiniteToolMaterial material, float attackDamage, FabricItemSettings settings) {
