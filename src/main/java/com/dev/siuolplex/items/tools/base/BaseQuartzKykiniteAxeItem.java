...
public class BaseQuartzKykiniteAxeItem extends BaseKykiniteAxeItem {
        @Override
        ...
        public BaseQuartzKykiniteAxeItem(BaseQuartzKykiniteToolMaterial material, int attackDamage, FabricItemSettings settings) {
