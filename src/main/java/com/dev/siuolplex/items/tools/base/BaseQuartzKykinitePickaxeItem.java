...
public class BaseQuartzKykinitePickaxeItem extends BaseKykinitePickaxeItem {
    @Override
    ...
    public BaseQuartzKykinitePickaxeItem(BaseQuartzKykiniteToolMaterial material, int attackDamage, FabricItemSettings settings) {
