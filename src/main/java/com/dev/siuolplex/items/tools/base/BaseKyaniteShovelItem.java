...
public class BaseKyaniteShovelItem extends ShovelItem {
    ...
    public BaseKyaniteShovelItem(BaseKyaniteToolMaterial material, float attackDamage, FabricItemSettings settings) {
