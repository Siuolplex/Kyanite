...
public class BaseKykiniteShovelItem extends ShovelItem {
    ...
    public BaseKykiniteShovelItem(BaseKykiniteToolMaterial material, float attackDamage, FabricItemSettings settings) {
        super(material, attackDamage, -3f, settings);
        ...
        builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER_ID, "Shovel Danage", (double)this.attackDamage, EntityAttributeModifier.Operation.ADDITION));
        builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(ATTACK_SPEED_MODIFIER_ID, "Shovel Speed", -3, EntityAttributeModifier.Operation.ADDITION));
