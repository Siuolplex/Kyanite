...
public class BaseKykiniteAxeItem extends AxeItem {
    ...
    public BaseKykiniteAxeItem(BaseKykiniteToolMaterial material, int attackDamage, FabricItemSettings settings) {
        ...
        builder.put(EntityAttributes.GENERIC_MAX_HEALTH, new EntityAttributeModifier(UUID.fromString("743ce14d-2754-4d8c-9d17-a09a32f9536b"), "Weapon Health modifier", (double)this.maxHealth, EntityAttributeModifier.Operation.ADDITION));
        builder.put(EntityAttributes.GENERIC_ARMOR, new EntityAttributeModifier(UUID.fromString("743ce14d-2754-4d8c-9d17-a09a32f9536b"), "Weapon Armor modifier", (double)this.armor, EntityAttributeModifier.Operation.MULTIPLY_BASE));
