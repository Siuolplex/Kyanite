...
public class BaseKyaniteHoeItem extends HoeItem {
    ...
    public BaseKyaniteHoeItem(BaseKyaniteToolMaterial material, float attackSpeed, FabricItemSettings settings) {
