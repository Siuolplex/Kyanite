...
public class BaseKyaniteAxeItem extends AxeItem {
    ...
    public BaseKyaniteAxeItem(BaseKyaniteToolMaterial material, int attackDamage, FabricItemSettings settings) {
