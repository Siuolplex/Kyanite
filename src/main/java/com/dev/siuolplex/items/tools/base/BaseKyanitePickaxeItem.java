...
public class BaseKyanitePickaxeItem extends PickaxeItem {
    ...
    public BaseKyanitePickaxeItem(BaseKyaniteToolMaterial material, int attackDamage, FabricItemSettings settings) {
