...
public class BaseKyaniteArmorItem extends ArmorItem {
    ...
    public BaseKyaniteArmorItem(BaseKyaniteArmorMaterial material, EquipmentSlot slot, FabricItemSettings settings) {
    ...
    public BaseKyaniteArmorMaterial getMaterial() {
