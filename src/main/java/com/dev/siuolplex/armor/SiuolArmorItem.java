...
public class SiuolArmorItem extends ArmorItem {
    ...
    public SiuolArmorMaterial type;
    public Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public SiuolArmorItem(SiuolArmorMaterial material, EquipmentSlot slot, FabricItemSettings settings) {
        ...
        builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uUID, "Armor Attack modifier", (double)this.attackDamage, EntityAttributeModifier.Operation.ADDITION));
    ...
    public SiuolArmorMaterial getMaterial() {
        return this.type;
    }
